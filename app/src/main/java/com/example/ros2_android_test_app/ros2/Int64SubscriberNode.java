...
public class Int64SubscriberNode extends BaseComposableNode {
    private static final String TAG = "Int64SubscriberNode";
    private final String topic;
    private Subscription<std_msgs.msg.Int64> subscription;
    ...
    public Int64SubscriberNode(String name, String topic) {
        super(name);
        this.topic = topic;
    }
