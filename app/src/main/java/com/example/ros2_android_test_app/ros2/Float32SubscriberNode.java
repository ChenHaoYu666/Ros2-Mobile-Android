...
public class Float32SubscriberNode extends BaseComposableNode {
    private static final String TAG = "Float32SubscriberNode";
    private final String topic;
    private Subscription<std_msgs.msg.Float32> subscription;
    ...
    public Float32SubscriberNode(String name, String topic) {
        super(name);
        this.topic = topic;
    }
