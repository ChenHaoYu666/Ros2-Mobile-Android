...
public class Float64SubscriberNode extends BaseComposableNode {
    private static final String TAG = "Float64SubscriberNode";
    private final String topic;
    private Subscription<std_msgs.msg.Float64> subscription;
    ...
    public Float64SubscriberNode(String name, String topic) {
        super(name);
        this.topic = topic;
    }
